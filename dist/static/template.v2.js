...
`, false);
  ...
  function bylineTemplate(frontMatter) {
    const affiliation = frontMatter.authors[0].affiliations[0];
    const aff = affiliation.url ? `<a class="affiliation" href="${affiliation.url}">${affiliation.name}</a>` : `<span class="affiliation">${affiliation.name}</span>`;
    return `
